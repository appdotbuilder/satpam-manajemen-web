 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\AreaReport> $areaReports
 * @property-read int|null $area_reports_count
...
class User extends Authenticatable
{
    ...
    /**
     * Get the area reports for the user.
     */
    public function areaReports(): HasMany
    {
        return $this->hasMany(AreaReport::class);
    }
